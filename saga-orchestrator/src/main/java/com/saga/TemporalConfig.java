...
public class TemporalConfig {
    ...
    public WorkerFactory workerFactory(WorkflowClient workflowClient) {
        ...
        WorkerOptions workerOptions = WorkerOptions.newBuilder()
                .setMaxConcurrentActivityExecutionSize(200)  // Allow up to 200 concurrent activities
                .setMaxConcurrentWorkflowTaskExecutionSize(100)  // Allow up to 100 concurrent workflow tasks
                .build();
